...
<div id="content" style="margin-top: 20px">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Sửa sản phẩm phụ</li>
        </ol>
    </nav>

    <form style="float: left; width: 65%" action="<%=Utils.fullPath("FixSmallProduct")%>">
        <div class="section">
            ...
            <div class="input-info input-group-icon">
                <input name="price-pro" id="price-pro" type="text" placeholder="Giá thành sản phẩm"
                       value="<%=pr!=null?pr.getGiasanpham():""%>"/>
                <div class="input-icon"><i class="fa fa-align-center"></i></div>
            </div>
            <div class="input-info input-group-icon">
