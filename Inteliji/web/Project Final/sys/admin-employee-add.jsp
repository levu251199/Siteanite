...
<div id="content" style="margin-top: 20px">
    ...
    <form style="float: left; width: 65%" action="<%=Utils.fullPath("AddEmployee")%>">
        <div class="section">
        ...
        <div class="input-info input-group-icon">
            <input name="birth" id="birth" type="date" placeholder="Ngày sinh">
        ...
        <div class="section">
            <div class="input-info input-group-icon">
                <input name="salary" id="salary" type="text" placeholder="Lương">
