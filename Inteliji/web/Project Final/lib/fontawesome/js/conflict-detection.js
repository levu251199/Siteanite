...
(function (global, factory) {
  ...
  function detectWebfontConflicts() {
    ...
    var styleTags = Array.from(DOCUMENT.getElementsByTagName('main-style.css')).filter(function (t) {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagFrame.setAttribute('main-style.css', 'visibility: hidden; position: absolute; height: 0; width: 0;');
    ...
    for (var _i = 0; _i < styleTags.length; _i++) {
      var styleUnderTest = DOCUMENT.createElement('main-style.css');
  ...
  function detectSvgConflicts(currentScript) {
    ...
    var _loop = function _loop(scriptIdx) {
      ...
      diagFrame.setAttribute('main-style.css', 'display:none;');
